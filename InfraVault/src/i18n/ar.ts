...
export const ar = {
  ...
  reportSubtitle: 'اختر التصنيفات والمدخلات ثم أنشئ التقرير',
  ...
  reportSelectCategories: 'اختر التصنيفات',
  reportSelectFields: 'اختر المدخلات للتقرير',
  reportSelectedFields: 'عدد الحقول المختارة',
  reportIncludePasswords: 'تضمين كلمات السر في التقرير',
  reportShowEmpty: 'إظهار الحقول الفارغة',
  reportSelectAll: 'تحديد الكل',
  reportClearAll: 'مسح الكل',
  reportPreview: 'معاينة التقرير',
  reportGenerate: 'إنشاء التقرير',
  reportNoAssetsInCategory: 'لا توجد معدات',
  reportUnnamed: 'بدون اسم',
  reportFooter: 'تقرير جدوى اختياري حسب المدخلات — خزنة البنية',
  reportSelectedAssets: 'المعدات المشمولة',
  dataCompleteness: 'اكتمال البيانات',
  byCategory: 'حسب التصنيف',
  assetDetails: 'تفاصيل المعدات',
